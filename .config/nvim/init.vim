...
" Customize the colors used in the completion menu
highlight PmenuSel guibg=#555555 guifg=#ffffff
highlight Pmenu  guibg=#222222 guifg=#bbbbbb
highlight CmpItemKind guifg=#d8a657
...
augroup mygroup
  ...
  autocmd FileType python,go,json,yaml,sh setl formatexpr=CocAction('formatSelected')
